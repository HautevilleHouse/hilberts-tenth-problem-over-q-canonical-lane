...
Canonical Lane research workspace for a flagship problem in number theory and mathematical logic:
proving undecidability of rational Diophantine solvability through an admissible definability closure architecture.

## Main Manuscript

- [paper/HILBERTS_TENTH_PROBLEM_OVER_Q_PREPRINT.md](paper/HILBERTS_TENTH_PROBLEM_OVER_Q_PREPRINT.md)
- [paper/CANONICAL_ROUTING_INDEX.md](paper/CANONICAL_ROUTING_INDEX.md)

## Structure

- `paper/`
  - `HILBERTS_TENTH_PROBLEM_OVER_Q_PREPRINT.md`
...
1. Theorem chain first: read `paper/HILBERTS_TENTH_PROBLEM_OVER_Q_PREPRINT.md`.
...
Current H10Q runner policy:

- `repro/run_repro.sh` extracts, promotes, runs `scripts/h10q_closure_guard.py`, updates `repro/repro_manifest.json`, and enforces `fully_extracted` release-gate mode.
...
3. artifact key consumed by `scripts/h10q_closure_guard.py`.
...
- Manuscript target: [paper/HILBERTS_TENTH_PROBLEM_OVER_Q_PREPRINT.md](paper/HILBERTS_TENTH_PROBLEM_OVER_Q_PREPRINT.md)
