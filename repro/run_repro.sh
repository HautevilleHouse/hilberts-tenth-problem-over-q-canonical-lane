...
mkdir -p .codex_tmp/hilberts_tenth_problem_over_q
cp artifacts/stitch_constants.json .codex_tmp/hilberts_tenth_problem_over_q/stitch_constants.json
cp artifacts/constants_registry.json .codex_tmp/hilberts_tenth_problem_over_q/constants_registry.json
