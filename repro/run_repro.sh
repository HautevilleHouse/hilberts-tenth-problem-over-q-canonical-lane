...
mkdir -p .tmp/hilberts_tenth_problem_over_q
cp artifacts/stitch_constants.json .tmp/hilberts_tenth_problem_over_q/stitch_constants.json
cp artifacts/constants_registry.json .tmp/hilberts_tenth_problem_over_q/constants_registry.json
