...
mkdir -p .repro_tmp/hilberts_tenth_problem_over_q
cp artifacts/stitch_constants.json .repro_tmp/hilberts_tenth_problem_over_q/stitch_constants.json
cp artifacts/constants_registry.json .repro_tmp/hilberts_tenth_problem_over_q/constants_registry.json
python3 scripts/h10q_closure_guard.py --strict-coh-zero --registry artifacts/constants_registry.json --stitch artifacts/stitch_constants.json --out repro/certificate_runtime.json --history repro/drift_guard_runs.jsonl --pretty
